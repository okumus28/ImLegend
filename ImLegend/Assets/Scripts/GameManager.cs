...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] TextMeshProUGUI outOfText;
    ...
    private void Update()
    {
        ...
        if (comboPanel.activeSelf)
        {
            ...
            {
                Point(comboValue * comboValue * 100);
    ...
    public void GameOver()
    {
        ...
        int c = (int)(point * 0.1f) + (killedZombi * 20) + (int)distance / 10;
